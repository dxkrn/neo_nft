...
class ItemDetailItemListingFailedPage extends StatefulWidget {
  const ItemDetailItemListingFailedPage({super.key});

  @override
  State<ItemDetailItemListingFailedPage> createState() =>
      _ItemDetailItemListingFailedPageState();
}
                        ...
                        Column(
                          children: [
                            SizedBox(
                              ...
                              child: const Image(
                                image: AssetImage(
                                    'assets/icons/icon_listing_failed.png'),
                              ),
                            ),
                            SizedBox(
                              height: 24.w,
                            ...
                            Text(
                              'Sorry, your payment was not successful. Please try again or choose a different payment method.',
                              style: regularTextStyle.copyWith(
                                fontSize: 14.sp,
                                color: whiteColor.withOpacity(0.7),
                              ),
