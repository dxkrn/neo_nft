...
class MintCollectionSuccessPage extends StatefulWidget {
  const MintCollectionSuccessPage({super.key});

  @override
  State<MintCollectionSuccessPage> createState() =>
      _MintCollectionSuccessPageState();
}

class _MintCollectionSuccessPageState extends State<MintCollectionSuccessPage> {
  @override
                        ...
                        Column(
                          children: [
                            SizedBox(
                              ...
                              child: const Image(
                                image: AssetImage(
                                    'assets/icons/icon_collection_success.png'),
                              ),
                            ),
                            SizedBox(
                              height: 24.w,
