...
class MintNftDetailsPage extends StatefulWidget {
  ...
  @override
  State<MintNftDetailsPage> createState() => _MintNftDetailsPageState();
}

class _MintNftDetailsPageState extends State<MintNftDetailsPage> {
  @override
                        ...
                        Column(
                          ...
                          children: [
                            const CustomTextField(
                                title: 'Title',
                                hint: 'Write your NFT title...'),
                            const CustomTextField(
                              title: 'Description',
                              hint: 'Write your NFT description...',
                              maxLines: 5,
                            ),
