...
class AboutARPage extends StatelessWidget {
  const AboutARPage({super.key});
...
class AboutARSingle extends StatefulWidget {
  AboutARSingle({
    Key? key,
    required this.title,
    required this.desc,
  ...
  @override
  State<AboutARSingle> createState() => _AboutARSingleState();
}

class _AboutARSingleState extends State<AboutARSingle> {
  @override
  Widget build(BuildContext context) {
    return Container(
      margin:
